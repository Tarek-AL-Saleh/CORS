...
export const api = {
  ...
  predict: {
    ...
    bulkPredict: (data: { run_name: string, target_year: number, target_semester: string, target_campus: string, new_enrollees: number, slots: { csc_core: number, csc_elective: number, bif_core: number, bif_elective: number, mth: number, sta: number } }) => 
